...
public partial class ApplicationDbContext : IdentityDbContext<IdentityUser>
{
    ...
    {
        // เพิ่มการตั้งค่าการสร้างตารางของ Identity
        base.OnModelCreating(modelBuilder); // เรียกใช้การตั้งค่าพื้นฐานของ Identity
        ...
        modelBuilder.Entity<product>(entity =>
        {
            ...
            entity.Property(e => e.produnctpicture).HasMaxLength(256);
